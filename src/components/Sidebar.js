...
const Sidebar = () => {
  ...
  return (
    <div className="w-fit" id="nav-container">
      <ul
        id="navbar"
        className="nav flex-column text-center gap-2  px-2 py-4 border"
      >
            ...
            {expand ? (
              <div className="row flex">
                ...
                <div className="col text-start">
                  ...
                  <p className="text-gray-500 side-list">
        ...
        <li className="nav-item">
          <a
            href=""
            id="menu"
            className={expand ? "nav-link text-start" : "nav-link"}
          >
            MENU
          </a>
        </li>
        ...
        <li className={expand ? "nav-item text-start" : "nav-item"}>
          <a href="" className="nav-link">
            ...
            {expand ? (
              <h4 className="d-inline ms-3 align-text-top side-list">
                Live Deal
              </h4>
            ) : (
              <></>
